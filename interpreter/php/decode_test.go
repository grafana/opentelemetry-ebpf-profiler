...
func TestRetrieveExecuteExJumpLabelAddressAmd64(t *testing.T) {
	testdata := []struct {
		...
		{
			code: []byte{
				,
			},
	...
	for _, td := range testdata {
		res, err := retrieveExecuteExJumpLabelAddressAmd64(td.code, libpf.SymbolValue(td.codeAddress))
		require.NoError(t, err)
		assert.Equal(t, td.expected, res)
	}
}
...
func TestRetrieveJITBufferPtrAmd64(t *testing.T) {
	testdata := []struct {
		...
		{
			code: []byte{
				// retrieveJITBufferPtrWrapper f30f1efa48f705997e0300200100007407c3660f1f44000055ba030000004889e5534883ec08488b359b840300488b3dac840300e8e7b9f4ff85c0750b488b5d cc930 = 104e10 104df8

				0xf3, 0x0f, 0x1e, 0xfa, 0x48, 0xf7, 0x05, 0x99, 0x7e, 0x03, 0x00, 0x20, 0x01, 0x00, 0x00, 0x74, 0x07, 0xc3, 0x66, 0x0f, 0x1f, 0x44, 0x00, 0x00, 0x55, 0xba, 0x03, 0x00, 0x00, 0x00, 0x48, 0x89, 0xe5, 0x53, 0x48, 0x83, 0xec, 0x08, 0x48, 0x8b, 0x35, 0x9b, 0x84, 0x03, 0x00, 0x48, 0x8b, 0x3d, 0xac, 0x84, 0x03, 0x00, 0xe8, 0xe7, 0xb9, 0xf4, 0xff, 0x85, 0xc0, 0x75, 0x0b, 0x48, 0x8b, 0x5d,
			},
			codeAddress:  0xcc930,
	...
	for _, td := range testdata {
		buf, sz, err := retrieveJITBufferPtrAmd64(td.code, libpf.SymbolValue(td.codeAddress))
		require.NoError(t, err)
