...
SYMBLIB_PATH := $(shell realpath target/aarch64-unknown-linux-musl/release/libsymblib_capi.a)
else ifeq ($(TARGET_ARCH),amd64)
SYMBLIB_PATH := $(shell realpath target/x86_64-unknown-linux-musl/release/libsymblib_capi.a)
else
$(error Unsupported architecture: $(TARGET_ARCH))
endif
